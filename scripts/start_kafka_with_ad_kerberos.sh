...
# Usage:
#
#  ./start_kafka_with_ad_kerberos.sh install | uninstall | clean
#
# Version:
#   0.1 - 01-Feb-18 - [Eric Lubow] - Dedicated ZK, Kafka authenticated against Kerberos
...
function keytab_secret_setup () {
	...
	# Kafka Keytab
	echo -n "XXX KEYTAB HERE" > kafka_keytab.base64
...
function install () {
	...
	echo -n "Enter the AD/Kerberos server hostname (master.mesos): "
	read KDC
